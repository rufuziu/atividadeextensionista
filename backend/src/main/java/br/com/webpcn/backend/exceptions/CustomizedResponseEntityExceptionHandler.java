package br.com.webpcn.backend.exceptions;

import br.com.webpcn.backend.exceptions.errors.ErrorDetails;
import br.com.webpcn.backend.exceptions.user.UserEmailAlreadyInUseException;
import br.com.webpcn.backend.exceptions.user.UserNotCreatedException;
import br.com.webpcn.backend.exceptions.user.UserNotFoundException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public final ResponseEntity<ErrorDetails>
  handleUserEmailAlreadyUsedException(Exception ex,
                                      WebRequest request) {
    ErrorDetails errorDetails = new ErrorDetails(
            LocalDateTime.now(),
            ex.getMessage(),
  ...
  public final ResponseEntity<ErrorDetails>
  handleUserNotCreatedException(Exception ex,
                              WebRequest request) {
    ErrorDetails errorDetails = new ErrorDetails(
            LocalDateTime.now(),
            ex.getMessage(),
