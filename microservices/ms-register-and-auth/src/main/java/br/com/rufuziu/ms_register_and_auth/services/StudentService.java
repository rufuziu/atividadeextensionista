...
public class StudentService {
    ...
    public StudentService(StudentRepository repository, ModelMapper modelMapper, PasswordEncoder passwordEncoder) {
...
//    }
    ...
    public UserDTO readUser(String email) {
        Optional<Student> user = repository.findByEmail(email);
